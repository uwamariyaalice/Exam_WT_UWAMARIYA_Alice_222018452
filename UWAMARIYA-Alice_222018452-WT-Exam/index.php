...
<body style="background-image: url('./images/soccer.jpg'); background-repeat: no-repeat; background-size: cover;">

<div class="overlay">
  <div class="container">
    <h1>Welcome to virtual robotics training platform website</h1>
    <p>our website is the using robotics</p>
